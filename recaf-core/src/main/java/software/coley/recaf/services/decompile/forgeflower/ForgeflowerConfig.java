...
import recaf.relocation.libs.forgeflower.org.jetbrains.java.decompiler.main.extern.IFernflowerPreferences;
import recaf.relocation.libs.forgeflower.org.jetbrains.java.decompiler.util.InterpreterUtil;
...
public class ForgeflowerConfig extends BaseDecompilerConfig {
    ...
    private final ObservableBoolean sfn = new ObservableBoolean(true);
    private final ObservableBoolean iec = new ObservableBoolean(false);
    private final ObservableBoolean qin = new ObservableBoolean(true);
    private final ObservableBoolean ega = new ObservableBoolean(false);
    private final ObservableBoolean isl = new ObservableBoolean(true);
    private final ObservableString thr = new ObservableString("AUTO");
    ...
    private final ObservableBoolean dcl = new ObservableBoolean(true);
    ...
    public ForgeflowerConfig() {
        ...
        addValue(new BasicConfigValue<>("qin", boolean.class, qin));
        addValue(new BasicConfigValue<>("ega", boolean.class, ega));
        addValue(new BasicConfigValue<>("isl", boolean.class, isl));
        addValue(new BasicConfigValue<>("thr", String.class, thr));
        ...
        addValue(new BasicConfigValue<>("dcl", boolean.class, dcl));
    ...
    protected Map<String, Object> getFernflowerProperties() {
        ...
        getValues().forEach((key, value) -> {
            if (value.getValue() instanceof Boolean bool) {
                ...
                if ("ban".equals(key)) {
                    properties.put(key, Lists.of(str));
                } else {
